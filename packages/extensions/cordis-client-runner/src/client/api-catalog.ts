  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        parameters: [{ name: 'workspaceId', description: 'explicit target; absent opens a workspace-less temporary Session.' }],
      },
      {
