...
export const zh = {
  ...
  'document.unsupportedType': '仅支持 Markdown、PDF、DOCX、PPTX 格式的文档',
...
export const en = {
  ...
  'document.unsupportedType': 'Only Markdown, PDF, DOCX, and PPTX documents are supported',
  ...
  'queue.document': 'Queued document {name}',
